...
export function buildPersonaBlock(): string {
  return [IDENTITY_LINE, PERSONA_INSTRUCTION, MEMORY_HYPERDRIVE_INSTRUCTION, FIGURATIVE_LANGUAGE_INSTRUCTION, ANTI_SYCOPHANCY_INSTRUCTION, MEMORY_HONESTY_INSTRUCTION].join("\n\n");
}
