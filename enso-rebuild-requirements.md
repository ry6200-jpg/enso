...
**Status: Draft for review — v1.6 redesigns EN-030's curiosity mechanism to be objective-driven: the candidate pool generalizes to self-fact gaps (location, occupation) alongside third-party names, a new code-computed winding-down discriminator gates proactive turn-taking (R31), and connecting an observation (EN-041) becomes a first-class alternative to asking**
